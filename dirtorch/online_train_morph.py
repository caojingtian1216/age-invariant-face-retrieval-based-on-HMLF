...
#    criterion=TripletLoss(margin=0.3, hard_mining=False)#在线Hard Triplet Loss
    ...
    criterion_arc=ArcFaceLoss(embedding_dim=512, num_classes=600)
...
#    optim=Adam(net.parameters(),lr=0.0001)
    ...
    dataset = datasets.create('morph_trainvalid')
    ...
    for epoch in range(Epoch_num):
        ...
        dataset = datasets.create('morph_train')#创建数据集对象
        net.train()
        p,k=16,4
